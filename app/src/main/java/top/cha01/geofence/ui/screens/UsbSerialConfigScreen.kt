    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = { viewModel.baudRate = it.toIntOrNull() ?: 9600 },
                label = { Text("波特率") },
            ...
            OutlinedTextField(
                ...
                onValueChange = { viewModel.dataBits = it.toIntOrNull() ?: 8 },
                label = { Text("数据位") },
                modifier = Modifier.fillMaxWidth()
            )
            ...
            OutlinedTextField(
                ...
                onValueChange = { viewModel.parity = it },
                label = { Text("校验位") },
                modifier = Modifier.fillMaxWidth()
            )
            ...
            OutlinedTextField(
                ...
                onValueChange = { viewModel.stopBits = it.toIntOrNull() ?: 1 },
                label = { Text("停止位") },
                modifier = Modifier.fillMaxWidth()
            )
            ...
            OutlinedTextField(
                ...
                onValueChange = { viewModel.flowControl = it },
                label = { Text("流控制") },
                modifier = Modifier.fillMaxWidth()
            )
